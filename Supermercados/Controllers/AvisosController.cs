...
namespace AvisoService.Controllers
{
    ...
    public class AvisosController : ControllerBase
    {
       ...
       public ActionResult<IEnumerable<Aviso>> GetAvisoItems()
        ...
        [HttpGet]
        [Route("GetAvisoProducto/{localidad}/{producto}")]
        public ActionResult<IEnumerable<Aviso>> GetAvisoProducto(string localidad, string producto)
        {
            var avisoItems = _avisoService.GetAvisoProducto(localidad,producto);
